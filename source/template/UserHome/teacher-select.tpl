...
<div class="container top m20">
    <div class="row">
        <div class="col-md-10 wrap-body">
            <!-- *********************** 内容区域开始 *********************** -->
            <ul class="gold-detail-title nav nav-tabs foreign-detail-nav">
                <li class="active"><a href="###">选择课外教</a></li>
               
            </ul>
            <!-- 内容区域 -->
            <link rel="import" href="../../widget/UserHome.live/foreign.tpl?__inline">
            <!-- *********************** 内容区域结束 *********************** -->
        </div>
